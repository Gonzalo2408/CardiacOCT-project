...
python build_results.py \
    --results_folder "Z:/grodriguez/CardiacOCT/preds-test-set/predicted_results_model4_2d" \
    --mode "pullback" \
    --new_json_file "Z:/grodriguez/CardiacOCT/metrics_build/pullback_model_4_test_dice.json"