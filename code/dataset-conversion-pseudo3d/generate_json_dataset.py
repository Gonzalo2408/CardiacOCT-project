...
def main():
    target_base = 'Z:/grodriguez/CardiacOCT/data-2d/nnUNet_raw_data/Task506_CardiacOCT'
    target_imagesTr = 'Z:/grodriguez/CardiacOCT/data-2d/nnUNet_raw_data/Task506_CardiacOCT/imagesTr'
    target_imagesTs = 'Z:/grodriguez/CardiacOCT/data-2d/nnUNet_raw_data/Task506_CardiacOCT/imagesTs'
    task_name = 'Task506_CardiacOCT'
    dataset_description = 'Semantic segmentation of intracoronary OCT pullbacks in pseudo3D style (one frame before and after the annotation)'
    modalities = ('Rbefore', 'Gbefore', 'Bbefore', 'R', 'G', 'B', 'Rafter', 'Gafter', 'Bafter')
