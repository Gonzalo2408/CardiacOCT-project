...
class OCTDataloader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        mask = sitk.GetArrayFromImage(sitk.ReadImage(self.mask_paths[index]))
...
def main(argv):
    ...
    model_path = 'Z:/grodriguez/CardiacOCT/data-2d/results/nnUNet/2d/Task504_CardiacOCT/nnUNetTrainerV2__nnUNetPlansv2.1/fold_0/model_best.model'
    ...
    val_dataset = OCTDataloader(val_image_list, val_mask_list)
